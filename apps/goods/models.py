...
class GoodsSKU(BaseModel):
    ...
    status = models.SmallIntegerField(default=1, choices=status_choices, verbose_name='是否上下线')
...
class GoodsImage(BaseModel):
    ...
    def __str__(self):
        return GoodsSKU.objects.get(id=self.sku_id).name
...
class IndexTypeGoodsBanner(BaseModel):
    ...
    display_type = models.SmallIntegerField(default=1, choices=DISPLAY_TYPE_CHOICES, verbose_name='陈列类型')
    index = models.SmallIntegerField(default=0, verbose_name='展示顺序')
