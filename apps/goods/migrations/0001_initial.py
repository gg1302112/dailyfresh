    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_delete', models.BooleanField(verbose_name='删除时间', default=False)),
                ('name', models.CharField(verbose_name='商品sku名称', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(verbose_name='是否上下线', default=1, choices=[(0, '下线'), (1, '上线')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateField(verbose_name='更新时间', auto_now=True)),
                ('is_delete', models.BooleanField(verbose_name='删除时间', default=False)),
                ('display_type', models.SmallIntegerField(verbose_name='陈列类型', default=1, choices=[(0, '标题'), (1, '图片')])),
                ('index', models.SmallIntegerField(verbose_name='展示顺序', default=0)),
